			...
			<div class="offset-4 col-4">
				...
				<form name="loginForm" class="form-horizontal" id="loginForm" role="form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input id="user_name" type="text" class="form-control" name="user_name" placeholder="Username" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input id="user_pass" type="text" class="form-control" name="user_pass" placeholder="Password" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="" class="col-4">Verification Code</label>
                        <div class="col-8">
...
$("#loginForm").submit(function(event){
    ...
    request = $.ajax({
        url: "<?php echo base_url();?>login/admin_varify",
        type: "post",
        data: serializedData
    });
