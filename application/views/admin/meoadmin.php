                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="panel-heading" style="background:#007bff;">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <h3 class="panel-title">In Active User</h3>
                                        </div>
                                        <div class="col col-xs-6 text-right">
                                            <button data-toggle="toggle" type="button" class="btn btn-primary " id="inactiveuser"><i class="glyphicon glyphicon-plus"></i>Expand</button>
                                        </div>
                                    </div>
                                </div>
                                <!--end panne heading-->
                            ...
                            <table id="inactive-user" class="table table-hover table-bordered inactuser">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                             ...
                             <div class="panel panel-default panel-table">
                                <div class="panel-heading" style="background:#007bff;">
                                    <div class="row">
                                        ...
                                        <div class="col col-xs-6 text-right">
                                            <button data-toggle="toggle" type="button" class="btn btn-primary " id="activeuser"><i class="glyphicon glyphicon-plus"></i>Expand</button>
                                        </div>
                                    </div>
                                </div>
                                <!--end panne heading-->
                                ...
                                <div class="panel-body">
                            <table id="active-user" class="table table-hover table-bordered actuser">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Nid/Birth Certificate No</th>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default panel-table">
                                <div class="panel-heading" style="background:#007bff;">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <h3 class="panel-title">Registration wrong</h3>
                                        </div>
                                        <div class="col col-xs-6 text-right">
                                            <button data-toggle="toggle" type="button" class="btn btn-primary " id="registrationWrong"><i class="glyphicon glyphicon-plus"></i>Expand</button>
                                        </div>
                                    </div>
                                </div>
                                <!--end panne heading-->
                                ...
                                <div class="panel-body">
                                    <table id="reg-wrong" class="table table-hover table-bordered regwrong">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Nid/Birth Certificate No</th>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default panel-table">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <button data-toggle="toggle" type="button" class="btn btn-primary " id="landwrong"><i class="glyphicon glyphicon-plus"></i>Expand</button>
                                    </div>
                                </div>
                            </div>
                                 <!--end panne heading-->
                            ...
                            <div class="panel-body">
                            <table id="land-wrong" class="table table-hover table-bordered lwrong">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Nid/Birth Certificate No</th>
